...
def test_build_info_is_public_strict_and_no_store() -> None:
    ...
    assert payload["release_id"] == "UCPE-PROD-SAFE-3-20260915-A"
    assert payload["fingerprint"] == "UCPE LIVE BUILD · PROD-SAFE-3-20260915-A"
    assert payload["source_milestone"] == "prod-safe-3-convergence"
